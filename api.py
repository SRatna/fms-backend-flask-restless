...
manager = APIManager(app, flask_sqlalchemy_db=db, preprocessors=dict(GET_MANY=[auth_func], POST_MANY=[auth_func], GET_SINGLE=[auth_func], DELETE_SINGLE=[auth_func], DELETE_MANY=[auth_func], POST=[auth_func]))
